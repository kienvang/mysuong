...
namespace Library.Tools
{
    ...
    public abstract class SqlHelper
    {
        ...
        public static readonly string ConnectionStringShopCake = ConfigurationManager.ConnectionStrings["VbnShopCakeConnectString"].ConnectionString;
        public static readonly string ConnectionStringService = ConfigurationManager.ConnectionStrings["VbnServicesConnectString"].ConnectionString;
        ...
        {
            return ExecuteDataTable(ConnectionStringShopCake, cmdType, cmdText, commandParameters);
        }

        public static DataTable ExecuteDataTable(CommandType cmdType, string cmdText)
        {
            return ExecuteDataTable(ConnectionStringShopCake, cmdType, cmdText, null);
        }
