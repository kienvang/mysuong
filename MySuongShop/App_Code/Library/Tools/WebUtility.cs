...
namespace Library.Tools
{
    public class WebUtility
    {
        ...
        public static void SetFB(System.Web.UI.MasterPage Master, string key, string value, int index)
        {
            
            System.Web.UI.HtmlControls.HtmlMeta _HtmlMeta = new System.Web.UI.HtmlControls.HtmlMeta();
            _HtmlMeta.Attributes.Add("property", "og:" + key);
            _HtmlMeta.Content = Library.Tools.UnicodeConversion.CreateInstant().GetTextFromHtml(value);

            Master.Page.Header.Controls.AddAt(index, _HtmlMeta);
        }
