...
namespace LayerHelper.ShopCake.BLL
{
	public class DocumentManagerBase
	{
		...
		public int DeleteByVideoUploadType(string VideoUploadType)
		{
			int toReturn = 0;
			RelationPredicateBucket filter = new RelationPredicateBucket();
			
			IPredicateExpression _PredicateExpression = new PredicateExpression();
			_PredicateExpression.Add(DocumentFields.VideoUploadType == VideoUploadType);
			filter.PredicateExpression.Add(_PredicateExpression);
		...
		public int DeleteByFileSize(long FileSize)
		{
			int toReturn = 0;
			RelationPredicateBucket filter = new RelationPredicateBucket();
		...
		public int DeleteByUploadType(string UploadType)
		{
			int toReturn = 0;
			RelationPredicateBucket filter = new RelationPredicateBucket();
			
			IPredicateExpression _PredicateExpression = new PredicateExpression();
			_PredicateExpression.Add(DocumentFields.UploadType == UploadType);
			filter.PredicateExpression.Add(_PredicateExpression);
		...
		// Return EntityCollection<DocumentEntity>
		public EntityCollection<DocumentEntity> SelectByVideoUploadTypeLST(string VideoUploadType)
		{
			EntityCollection<DocumentEntity> _DocumentCollection = new EntityCollection<DocumentEntity>();
			RelationPredicateBucket filter = new RelationPredicateBucket();
		...
		// Return EntityCollection<DocumentEntity>
		public EntityCollection<DocumentEntity> SelectByVideoUploadTypeLST_Paged(string VideoUploadType, int PageNumber, int PageSize)
		{
			EntityCollection<DocumentEntity> _DocumentCollection = new EntityCollection<DocumentEntity>();
			RelationPredicateBucket filter = new RelationPredicateBucket();
		...
		// Return DataTable
		public DataTable SelectByVideoUploadTypeRDT(string VideoUploadType)
		{
			DataTable toReturn = new DataTable();
			EntityCollection _DocumentCollection = new EntityCollection(new DocumentEntityFactory());
			RelationPredicateBucket filter = new RelationPredicateBucket();
		...
		// Return DataTable
		public DataTable SelectByVideoUploadTypeRDT_Paged(string VideoUploadType, int PageNumber, int PageSize)
		{
			DataTable toReturn = new DataTable();
			EntityCollection _DocumentCollection = new EntityCollection(new DocumentEntityFactory());
			RelationPredicateBucket filter = new RelationPredicateBucket();
		...
		// Return EntityCollection<DocumentEntity>
		public EntityCollection<DocumentEntity> SelectByFileSizeLST(long FileSize)
		{
			EntityCollection<DocumentEntity> _DocumentCollection = new EntityCollection<DocumentEntity>();
			RelationPredicateBucket filter = new RelationPredicateBucket();
		...
		// Return EntityCollection<DocumentEntity>
		public EntityCollection<DocumentEntity> SelectByFileSizeLST_Paged(long FileSize, int PageNumber, int PageSize)
		{
			EntityCollection<DocumentEntity> _DocumentCollection = new EntityCollection<DocumentEntity>();
			RelationPredicateBucket filter = new RelationPredicateBucket();
		...
		// Return DataTable
		public DataTable SelectByFileSizeRDT(long FileSize)
		{
			DataTable toReturn = new DataTable();
			EntityCollection _DocumentCollection = new EntityCollection(new DocumentEntityFactory());
			RelationPredicateBucket filter = new RelationPredicateBucket();
		...
		// Return DataTable
		public DataTable SelectByFileSizeRDT_Paged(long FileSize, int PageNumber, int PageSize)
		{
			DataTable toReturn = new DataTable();
			EntityCollection _DocumentCollection = new EntityCollection(new DocumentEntityFactory());
			RelationPredicateBucket filter = new RelationPredicateBucket();
		...
		// Return EntityCollection<DocumentEntity>
		public EntityCollection<DocumentEntity> SelectByUploadTypeLST(string UploadType)
		{
			EntityCollection<DocumentEntity> _DocumentCollection = new EntityCollection<DocumentEntity>();
			RelationPredicateBucket filter = new RelationPredicateBucket();
		...
		// Return EntityCollection<DocumentEntity>
		public EntityCollection<DocumentEntity> SelectByUploadTypeLST_Paged(string UploadType, int PageNumber, int PageSize)
		{
			EntityCollection<DocumentEntity> _DocumentCollection = new EntityCollection<DocumentEntity>();
			RelationPredicateBucket filter = new RelationPredicateBucket();
		...
		// Return DataTable
		public DataTable SelectByUploadTypeRDT(string UploadType)
		{
			DataTable toReturn = new DataTable();
			EntityCollection _DocumentCollection = new EntityCollection(new DocumentEntityFactory());
			RelationPredicateBucket filter = new RelationPredicateBucket();
		...
		// Return DataTable
		public DataTable SelectByUploadTypeRDT_Paged(string UploadType, int PageNumber, int PageSize)
		{
			DataTable toReturn = new DataTable();
			EntityCollection _DocumentCollection = new EntityCollection(new DocumentEntityFactory());
			RelationPredicateBucket filter = new RelationPredicateBucket();
