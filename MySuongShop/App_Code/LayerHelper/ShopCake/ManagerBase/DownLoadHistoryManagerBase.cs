...
namespace LayerHelper.ShopCake.BLL
{
	public class DownLoadHistoryManagerBase
	{
		...
		public DownLoadHistoryEntity Insert(Guid Id, Guid CustomerId, Guid DocumentId, DateTime Date, long MarkBeforeDown, long MarkAfterDown, string ClientIp, DateTime CreatedDate, string CreatedBy, DateTime UpdatedDate, string UpdatedBy, bool IsDeleted)
		{
			...
			using(DataAccessAdapterBase adapter = (new DataAccessAdapterFactory()).CreateAdapter())
			{
				...
				_DownLoadHistoryEntity.ClientIp = ClientIp;
		...
		public DownLoadHistoryEntity Insert(Guid CustomerId, Guid DocumentId, DateTime Date, long MarkBeforeDown, long MarkAfterDown, string ClientIp, DateTime CreatedDate, string CreatedBy, DateTime UpdatedDate, string UpdatedBy, bool IsDeleted)
		{
			DownLoadHistoryEntity _DownLoadHistoryEntity = new DownLoadHistoryEntity();
			using(DataAccessAdapterBase adapter = (new DataAccessAdapterFactory()).CreateAdapter())
			{
		...
		public bool Update(Guid Id, Guid CustomerId, Guid DocumentId, DateTime Date, long MarkBeforeDown, long MarkAfterDown, string ClientIp, DateTime CreatedDate, string CreatedBy, DateTime UpdatedDate, string UpdatedBy, bool IsDeleted)
		{
			bool toReturn = false;
			using(DataAccessAdapterBase adapter = (new DataAccessAdapterFactory()).CreateAdapter())
			{
		...
		public int DeleteByClientIp(string ClientIp)
		{
			...
			IPredicateExpression _PredicateExpression = new PredicateExpression();
			_PredicateExpression.Add(DownLoadHistoryFields.ClientIp == ClientIp);
			filter.PredicateExpression.Add(_PredicateExpression);
		...
		// Return EntityCollection<DownLoadHistoryEntity>
		public EntityCollection<DownLoadHistoryEntity> SelectByClientIpLST(string ClientIp)
		{
			EntityCollection<DownLoadHistoryEntity> _DownLoadHistoryCollection = new EntityCollection<DownLoadHistoryEntity>();
			RelationPredicateBucket filter = new RelationPredicateBucket();
		...
		// Return EntityCollection<DownLoadHistoryEntity>
		public EntityCollection<DownLoadHistoryEntity> SelectByClientIpLST_Paged(string ClientIp, int PageNumber, int PageSize)
		{
			EntityCollection<DownLoadHistoryEntity> _DownLoadHistoryCollection = new EntityCollection<DownLoadHistoryEntity>();
			RelationPredicateBucket filter = new RelationPredicateBucket();
