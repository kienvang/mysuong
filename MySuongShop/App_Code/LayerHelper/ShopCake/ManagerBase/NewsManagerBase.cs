...
namespace LayerHelper.ShopCake.BLL
{
	public class NewsManagerBase
	{
		...
		public NewsEntity Insert(Guid Id, string Subject, string TextId, string Description, string Body, bool IsMenu, DateTime CreatedDate, string CreatedBy, bool IsVisible)
		{
			...
			using(DataAccessAdapterBase adapter = (new DataAccessAdapterFactory()).CreateAdapter())
			{
				...
				_NewsEntity.Description = Description;
				_NewsEntity.Body = Body;
				_NewsEntity.IsMenu = IsMenu;
		...
		public NewsEntity Insert(string Subject, string TextId, string Description, string Body, bool IsMenu, DateTime CreatedDate, string CreatedBy, bool IsVisible)
		{
			NewsEntity _NewsEntity = new NewsEntity();
			using(DataAccessAdapterBase adapter = (new DataAccessAdapterFactory()).CreateAdapter())
			{
		...
		public bool Update(Guid Id, string Subject, string TextId, string Description, string Body, bool IsMenu, DateTime CreatedDate, string CreatedBy, bool IsVisible)
		{
			bool toReturn = false;
			using(DataAccessAdapterBase adapter = (new DataAccessAdapterFactory()).CreateAdapter())
			{
		...
		public int DeleteByDescription(string Description)
		{
			...
			IPredicateExpression _PredicateExpression = new PredicateExpression();
			_PredicateExpression.Add(NewsFields.Description == Description);
			filter.PredicateExpression.Add(_PredicateExpression);
		...
		public int DeleteByIsMenu(bool IsMenu)
		{
			int toReturn = 0;
			RelationPredicateBucket filter = new RelationPredicateBucket();
			
			IPredicateExpression _PredicateExpression = new PredicateExpression();
			_PredicateExpression.Add(NewsFields.IsMenu == IsMenu);
			filter.PredicateExpression.Add(_PredicateExpression);
		...
		// Return EntityCollection<NewsEntity>
		public EntityCollection<NewsEntity> SelectByDescriptionLST(string Description)
		{
			EntityCollection<NewsEntity> _NewsCollection = new EntityCollection<NewsEntity>();
			RelationPredicateBucket filter = new RelationPredicateBucket();
		...
		// Return EntityCollection<NewsEntity>
		public EntityCollection<NewsEntity> SelectByDescriptionLST_Paged(string Description, int PageNumber, int PageSize)
		{
			EntityCollection<NewsEntity> _NewsCollection = new EntityCollection<NewsEntity>();
			RelationPredicateBucket filter = new RelationPredicateBucket();
		...
		// Return EntityCollection<NewsEntity>
		public EntityCollection<NewsEntity> SelectByIsMenuLST(bool IsMenu)
		{
			EntityCollection<NewsEntity> _NewsCollection = new EntityCollection<NewsEntity>();
			RelationPredicateBucket filter = new RelationPredicateBucket();
		...
		// Return EntityCollection<NewsEntity>
		public EntityCollection<NewsEntity> SelectByIsMenuLST_Paged(bool IsMenu, int PageNumber, int PageSize)
		{
			EntityCollection<NewsEntity> _NewsCollection = new EntityCollection<NewsEntity>();
			RelationPredicateBucket filter = new RelationPredicateBucket();
		...
		// Return DataTable
		public DataTable SelectByIsMenuRDT(bool IsMenu)
		{
			DataTable toReturn = new DataTable();
			EntityCollection _NewsCollection = new EntityCollection(new NewsEntityFactory());
			RelationPredicateBucket filter = new RelationPredicateBucket();
		...
		// Return DataTable
		public DataTable SelectByIsMenuRDT_Paged(bool IsMenu, int PageNumber, int PageSize)
		{
			DataTable toReturn = new DataTable();
			EntityCollection _NewsCollection = new EntityCollection(new NewsEntityFactory());
			RelationPredicateBucket filter = new RelationPredicateBucket();
