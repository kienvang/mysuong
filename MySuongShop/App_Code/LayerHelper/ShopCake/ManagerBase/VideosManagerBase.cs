...
namespace LayerHelper.ShopCake.BLL
{
	public class VideosManagerBase
	{
		...
		public VideosEntity Insert(Guid Id, int CatalogId, int IntId, string VideoName, string TextId, string Thumbnail, string Path, string UploadType, string ObjectType, string CodeEmbed, bool IsEmbeb, string VideoTypeId, bool AutoStart, bool IsVisibleHome, string Descriptions, int Views, DateTime CreatedDate, string CreatedBy)
		{
		...
		public bool Update(Guid Id, int CatalogId, int IntId, string VideoName, string TextId, string Thumbnail, string Path, string UploadType, string ObjectType, string CodeEmbed, bool IsEmbeb, string VideoTypeId, bool AutoStart, bool IsVisibleHome, string Descriptions, int Views, DateTime CreatedDate, string CreatedBy)
		{
			bool toReturn = false;
			using(DataAccessAdapterBase adapter = (new DataAccessAdapterFactory()).CreateAdapter())
			{
		...
		public int DeleteByUploadType(string UploadType)
		{
			...
			IPredicateExpression _PredicateExpression = new PredicateExpression();
			_PredicateExpression.Add(VideosFields.UploadType == UploadType);
			filter.PredicateExpression.Add(_PredicateExpression);
		...
		// Return EntityCollection<VideosEntity>
		public EntityCollection<VideosEntity> SelectByUploadTypeLST(string UploadType)
		{
			EntityCollection<VideosEntity> _VideosCollection = new EntityCollection<VideosEntity>();
			RelationPredicateBucket filter = new RelationPredicateBucket();
		...
		// Return EntityCollection<VideosEntity>
		public EntityCollection<VideosEntity> SelectByUploadTypeLST_Paged(string UploadType, int PageNumber, int PageSize)
		{
			EntityCollection<VideosEntity> _VideosCollection = new EntityCollection<VideosEntity>();
			RelationPredicateBucket filter = new RelationPredicateBucket();
